...
const sections = [
  {
    ...
    body: `발링크(이하 '회사')은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
    ...
    <div className="flex flex-col h-full" style={{ backgroundColor: "#f5f5f7" }}>
      ...
      >
        ...
        >
          ...
          >
            발링크(이하 '회사')은 이용자의 개인정보를 중요하게 생각합니다. 이 개인정보처리방침은 회사가 제공하는 발링크 앱 서비스 이용 시 수집하는 개인정보의 항목, 수집 및 이용 목적, 보유 기간, 제3자 제공 여부 등을 안내합니다.
          </p>
        </div>
