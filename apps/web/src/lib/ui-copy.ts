...
export const emptyCopy = {
  ...
  notifications: {
    title: "아직 받은 알림이 없어요",
    description: "알림 조건에 맞는 공고가 올라오면 여기에 표시돼요.",
  },
  notificationsGuest: {
    title: "맞춤 알림은 로그인 후 이용할 수 있어요",
    description: "지역·요일 조건을 저장하고 내 알림함을 확인해 보세요.",
    cta: "로그인하기",
  },
  notificationRules: {
    title: "아직 알림 조건이 없어요",
    description:
      "지역·유형·요일·시간대를 설정해 두면, 맞는 공고가 올라올 때 알림함으로 와요.",
    cta: "조건 설정하기",
    inline: "아직 알림 조건이 없어요",
  },
  interestRegions: {
...
export const notificationCopy = {
  ...
  rulesHeading: "알림 조건",
  rulesHelp:
    "조건마다 지역·정규/대강·요일·시간대를 따로 정해요. 하나라도 맞으면 알림이 와요.",
  rulesPreviewLabel: "이렇게 알림이 와요",
  regionRequired: "지역을 선택해야 이 조건으로 알림이 가요.",
  noEnabledRules: "켜져 있는 조건이 없어요.",
  noRegionRules: "지역이 선택된 조건이 없어요. 각 조건에서 지역을 골라 주세요.",
  deleteConfirm: "조건을 삭제할까요? 삭제하면 이 조건으로는 더 이상 알림이 오지 않아요.",
  masterAria: "알림 받기",
  markAllRead: "모두 읽음",
  backToInbox: "← 알림함",
  backToRules: "← 알림 조건",
